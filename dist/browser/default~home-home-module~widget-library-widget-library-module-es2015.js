...
class CountryPhone {
    constructor(iso, name) {
        ...
        // this.code = code;
        this.name = name;
        const phoneUtil = google_libphonenumber__WEBPACK_IMPORTED_MODULE_1__["PhoneNumberUtil"].getInstance();
        const PNF = google_libphonenumber__WEBPACK_IMPORTED_MODULE_1__["PhoneNumberFormat"];
        const PNT = google_libphonenumber__WEBPACK_IMPORTED_MODULE_1__["PhoneNumberType"];
