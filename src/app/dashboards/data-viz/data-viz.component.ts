...
// data viz snapshot object
  ...
  constructor(
    ...
    private datavizService: DashboardsService,
    private route: ActivatedRoute
  ) {
    this.isBrowser = isPlatformBrowser(platformId);
    // tslint:disable-next-line:no-string-literal
    this.dataViz =  route.snapshot.data['data'].USA
...
getCovid() {
    this.viz = this.datavizService.getAllStatesCovid().subscribe((res => {
      this.viz = res;
        }
    ));
}
