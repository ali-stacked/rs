...
@Component({
  ...
  templateUrl: './tennis-filters.component.html',
  styleUrls: [
    './tennis-filters.component.scss'
  ],
  providers: [DatePipe]
})

export class TennisFiltersComponent implements OnInit {
  ...
  recentOrdersTableDisplayedColumns: string[] = ['rank', 'name', 'weeksAtNo1', 'bigTitles', 'rankingPoints', 'titles',
    'wonLost',
    'wonPct',
    ];
