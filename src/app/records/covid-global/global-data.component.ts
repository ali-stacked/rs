...
export interface RowData {
  ...
  yesterday: number;
  deathTotal: number;
  deathsPerMill: number;
  deathWeek: number;
  deathsYesterday:number;
}
...
@Component({
  ...
  styleUrls: [
    './global-data.component.scss'
  ],
  providers: [DatePipe]
})

export class GlobalCovidGridComponent implements OnInit {
  // Filters for the smart table
  filtersForm: FormGroup;
  filtersVisible = true;
  toggleFiltersLabel = 'Hide filters';

  recentOrdersTableDisplayedColumns: string[] = ['name',
    'casesTotal',
    'perMill',
    'thisWeak',
    'yesterday',
